...
const ShortGameReflection = ({ navigation, route }) => {
    ...
    const reflectionOptions = [
        {
            ...
            description: 'Focus on controlling shot distances'
        },
        {
            id: 'trajectory',
            title: 'Trajectory Control',
            description: 'Working on ball flight and trajectory'
        },
        {
            id: 'block',
            title: 'Block Work',
            description: 'Practice with specific shot blocks'
        },
        {
            id: 'direction',
            title: 'Direction Control',
            description: 'Focus on shot direction and alignment'
        },
        {
            id: 'fundamentals',
            title: 'Short Fundamentals',
            description: 'Basic short game technique work'
        },
        {
            id: 'competitive',
        ...
        {
            id: 'launch',
            title: 'Launch Monitor Used',
            description: 'Using launch monitor for feedback'
        },
        {
            id: 'tempo',
            title: 'Tempo',
            description: 'Working on swing tempo and rhythm'
        },
        {
            id: 'routine',
            title: 'Practice Using Your Routine',
            description: 'Following your pre-shot routine'
        }
    ];
        ...
        <SafeAreaView className="flex-1 bg-[#1C1C1E]">
            <StyledView className="flex-1">
                ...
                <StyledView className="flex-row items-center justify-between py-4 px-4">
                    ...
                    <StyledText className="text-white text-xl font-semibold">Short Game Reflection</StyledText>
...
export default ShortGameReflection; 
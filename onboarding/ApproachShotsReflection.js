...
const ApproachShotsReflection = ({ navigation, route }) => {
    ...
    const reflectionOptions = [
        ...
        },
        {
            ...
            description: 'Basic full swing technique work'
        },
        {
            id: 'competitive',
        ...
        <SafeAreaView className="flex-1 bg-[#1C1C1E]">
            <StyledView className="flex-1">
                ...
                <StyledView className="flex-row items-center justify-between py-4 px-4">
                    ...
                    <StyledText className="text-white text-xl font-semibold">Approach Shots Reflection</StyledText>
...
export default ApproachShotsReflection; 